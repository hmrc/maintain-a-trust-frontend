...
class TaskListController @Inject() (
  ...
  def onPageLoad(): Action[AnyContent] = actions.refreshAndRequireIsClosingAnswer.async { implicit request =>
    val result = for {
  ...
  def onSubmit(): Action[AnyContent] = actions.requireIsClosingAnswer { implicit request =>
