...
import models.pages.{WhatIsNext, WhatIsNext5mld}
...
case object WhatIsNext5mldPage extends QuestionPage[WhatIsNext5mld] {

  override def path: JsPath = JsPath \ toString

  override def toString: String = "whatIsNext"

  override def cleanup(value: Option[WhatIsNext5mld], userAnswers: UserAnswers): Try[UserAnswers] = {
    value match {
      case _ =>
