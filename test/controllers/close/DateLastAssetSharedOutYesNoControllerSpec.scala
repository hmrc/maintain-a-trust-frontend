...
class DateLastAssetSharedOutYesNoControllerSpec extends SpecBase with MockitoSugar {
  ...
  "DateLastAssetSharedOutYesNo Controller" must {
    ...
    "return OK and the correct view for a GET" in {
      ...
      val view = application.injector.instanceOf[DateLastAssetSharedOutYesNoView]
    ...
    "redirect to the next page when YES is submitted" in {
      ...
      redirectLocation(result).value mustEqual routes.DateLastAssetSharedOutController.onPageLoad().url
    ...
    "redirect to the next page when NO is submitted" in {
      ...
      redirectLocation(result).value mustEqual routes.HowToCloseATrustController.onPageLoad().url
