...
class CompanyBeneficiaryExtractorSpec
    ...
    "when there are companies" - {
      ...
      "for a 5mld taxable trust" - {
        ...
        "with full data must return user answers updated" in {
          ...
          extraction.value.get(CompanyBeneficiaryAddressPage(0)).get                        mustBe InternationalAddress(
            "line 0",
            "line2",
            None,
            "DE"
          ...
          extraction.value.get(CompanyBeneficiaryAddressPage(2)).get                 mustBe UKAddress(
            "line 2",
            "line2",
            None,
            None,
