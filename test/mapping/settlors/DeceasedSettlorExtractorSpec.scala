...
class DeceasedSettlorExtractorSpec
    ...
    "when there is a Deceased Settlor" - {
      ...
      "for a 5mld taxable trust" - {
        ...
        "with name and UK address, must return user answers updated" in {
          ...
          extraction.value.get(SettlorLastKnownAddressPage).get                  mustBe UKAddress(
            "line 1",
            "line2",
            None,
            None,
        ...
        "with name and International address, must return user answers updated" in {
          ...
          extraction.value.get(SettlorLastKnownAddressPage).get                  mustBe InternationalAddress(
            "Int line 1",
            "Int line2",
            None,
            "DE"
          ...
          val deceasedSettlor = DisplayTrustWillType(
            ...
            identification = Some(
              DisplayTrustIdentificationType(
                ...
                nino = None,
                passport =
                  Some(PassportType("DE", "KSJDFKSDHF6456545147852369QWER", LocalDate.of(year2020, FEBRUARY, 2))),
                address = None
              )
            ),
            entityStart = "2019-11-26"
