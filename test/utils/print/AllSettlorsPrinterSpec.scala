...
class AllSettlorsPrinterSpec extends SpecBase {
  ...
  private val (year1991, year2010, year2020, year2021, num1, num4, num10, num27) =
    (1991, 2010, 2020, 2021, 1, 4, 10, 27)
  ...
  "AllSettlorsPrinter" must {
    ...
    "generate deceased settlor sections for maximum dataset" in {
      ...
      val answers = emptyUserAnswersForUtr
        .set(SettlorNamePage, FullName("Adam", None, "Smith"))
        .value
        .set(SettlorDateOfDeathYesNoPage, true)
        .value
        .set(SettlorDateOfDeathPage, LocalDate.of(year2010, OCTOBER, num10))
        .value
        .set(SettlorDateOfBirthYesNoPage, true)
        .value
        .set(SettlorDateOfBirthPage, LocalDate.of(year1991, AUGUST, num27))
        .value
        .set(DeceasedSettlorCountryOfNationalityYesNoPage, true)
        .value
        .set(DeceasedSettlorCountryOfNationalityInTheUkYesNoPage, false)
        .value
        .set(DeceasedSettlorCountryOfNationalityPage, "FR")
        .value
        .set(SettlorNationalInsuranceYesNoPage, true)
        .value
        .set(SettlorNationalInsuranceNumberPage, "JP121212A")
        .value
        .set(DeceasedSettlorCountryOfResidenceYesNoPage, true)
        .value
        .set(DeceasedSettlorCountryOfResidenceInTheUkYesNoPage, false)
        .value
        .set(DeceasedSettlorCountryOfResidencePage, "FR")
        .value
      ...
      result mustBe Seq(
        ...
        AnswerSection(
          ...
          rows = Seq(
            AnswerRow(
              label = messages("settlorDeceasedName.checkYourAnswersLabel"),
              answer = Html("Adam Smith"),
              changeUrl = None
            ),
            AnswerRow(
              label = messages("settlorDeceasedDateOfDeathYesNo.checkYourAnswersLabel", name),
              answer = Html("Yes"),
              changeUrl = None
            ),
            AnswerRow(
              label = messages("settlorDeceasedDateOfDeath.checkYourAnswersLabel", name),
              answer = Html("10 October 2010"),
              changeUrl = None
            ),
            AnswerRow(
              label = messages("settlorDeceasedDateOfBirthYesNo.checkYourAnswersLabel", name),
              answer = Html("Yes"),
              changeUrl = None
            ),
            AnswerRow(
              label = messages("settlorDeceasedDateOfBirth.checkYourAnswersLabel", name),
              answer = Html("27 August 1991"),
              changeUrl = None
            ),
            AnswerRow(
              label = messages("settlorDeceasedCountryOfNationalityYesNo.checkYourAnswersLabel", name),
              answer = Html("Yes"),
              changeUrl = None
            ),
            AnswerRow(
              label = messages("settlorDeceasedCountryOfNationalityUkYesNo.checkYourAnswersLabel", name),
              answer = Html("No"),
              changeUrl = None
            ),
            AnswerRow(
              label = messages("settlorDeceasedCountryOfNationality.checkYourAnswersLabel", name),
              answer = Html("France"),
              changeUrl = None
            ),
            AnswerRow(
              label = messages("settlorDeceasedNationalInsuranceYesNo.checkYourAnswersLabel", name),
              answer = Html("Yes"),
              changeUrl = None
            ),
            AnswerRow(
              label = messages("settlorDeceasedNationalInsuranceNumber.checkYourAnswersLabel", name),
              answer = Html("JP 12 12 12 A"),
              changeUrl = None
            ),
            AnswerRow(
              label = messages("settlorDeceasedCountryOfResidenceYesNo.checkYourAnswersLabel", name),
              answer = Html("Yes"),
              changeUrl = None
            ),
            AnswerRow(
              label = messages("settlorDeceasedCountryOfResidenceUkYesNo.checkYourAnswersLabel", name),
              answer = Html("No"),
              changeUrl = None
            ),
            AnswerRow(
              label = messages("settlorDeceasedCountryOfResidence.checkYourAnswersLabel", name),
              answer = Html("France"),
              changeUrl = None
            )
          ),
    ...
    "correctly display nationality and residency questions" when {
      ...
      "nationality and residency unknown" in {
        ...
        val answers = emptyUserAnswersForUtr
          ...
          .value
          .set(DeceasedSettlorCountryOfNationalityYesNoPage, false)
          .value
          .set(SettlorNationalInsuranceYesNoPage, true)
          .value
          .set(SettlorNationalInsuranceNumberPage, "JP121212A")
          .value
          .set(DeceasedSettlorCountryOfResidenceYesNoPage, false)
          .value
      ...
      "only nationality unknown" in {
        ...
        val answers = emptyUserAnswersForUtr
          ...
          .set(DeceasedSettlorCountryOfResidenceYesNoPage, true)
          .value
          .set(DeceasedSettlorCountryOfResidenceInTheUkYesNoPage, true)
          .value
      ...
      "only residency unknown" in {
        ...
        val answers = emptyUserAnswersForUtr
          ...
          .set(DeceasedSettlorCountryOfNationalityYesNoPage, true)
          .value
          .set(DeceasedSettlorCountryOfNationalityInTheUkYesNoPage, true)
          .value
          .set(SettlorNationalInsuranceYesNoPage, true)
          .value
          .set(SettlorNationalInsuranceNumberPage, "JP121212A")
    ...
    "generate deceased settlor sections for minimum dataset" in {
      ...
      val answers = emptyUserAnswersForUtr
        ...
        .value
        .set(SettlorLastKnownAddressYesNoPage, true)
        .value
        .set(SettlorLastKnownAddressUKYesNoPage, true)
        .value
        .set(
          SettlorLastKnownAddressPage,
          UKAddress(
            line1 = "line 1",
            line2 = "line 2",
            line3 = Some("line 3"),
      ...
      result mustBe Seq(
        ...
        AnswerSection(
          ...
          rows = Seq(
            ...
            AnswerRow(
              label = messages("settlorDeceasedLastKnownAddressYesNo.checkYourAnswersLabel", name),
              answer = Html("Yes"),
              changeUrl = None
            ),
            AnswerRow(
              label = messages("settlorDeceasedLastKnownAddressUKYesNo.checkYourAnswersLabel", name),
              answer = Html("Yes"),
              changeUrl = None
            ),
            AnswerRow(
              label = messages("settlorDeceasedUKAddress.checkYourAnswersLabel", name),
              answer = Html("line 1<br />line 2<br />line 3<br />line 4<br />NE981ZZ"),
              changeUrl = None
            ),
            AnswerRow(
              label = messages("settlorDeceasedPassportOrIdCard.checkYourAnswersLabel", name),
              answer = Html("Germany<br />123456789<br />10 October 2021"),
              changeUrl = None
            )
          ),
          sectionKey = None
    ...
    def uaSet[T: Writes](settable: Settable[T], value: T)(implicit reads: Reads[T]): UserAnswers => UserAnswers =
      _.set(settable, value).value

    "generate Company Settlor Section" in {
      def businessSettlorBase(index: Int) =
        uaSet(SettlorIndividualOrBusinessPage(index), IndividualOrBusiness.Business) andThen
      ...
      result mustBe Seq(
        ...
        AnswerSection(
          ...
          Seq(
            ...
            AnswerRow(
              "What is International Exports’s Unique Taxpayer Reference (UTR) number?",
              Html("UTRUTRUTRUTR"),
              None
            ),
        ...
        AnswerSection(
          ...
          Seq(
            ...
            AnswerRow(
              "What is International Exports’s address?",
              Html("Line1<br />Line2<br />Line3<br />POSTCODE"),
              None
            )
          ),
          None
        ...
        AnswerSection(
          ...
          Seq(
            ...
            AnswerRow(
              "What is International Exports’s address?",
              Html("Line1<br />Line2<br />Line3<br />Dutch Antilles"),
              None
            )
          ),
          None
        ...
        AnswerSection(
          ...
          Seq(
            ...
            AnswerRow(
              "At the date of each contribution to the trust, had the business been in existence for at least 2 years?",
              Html("No"),
              None
            )
          ),
      ...
      result mustBe Seq(
        ...
        AnswerSection(
          ...
          Seq(
            ...
            AnswerRow(
              "What are Joe Bloggs’s passport or ID card details?",
              Html("Germany<br />Number ending 7890<br />1 January 2020"),
              None
            ),
            AnswerRow("Does Joe Bloggs have mental capacity at the time of registration?", Html("Yes"), None)
          ),
    ...
    "generate sections with deceased settlor and additional settlors" in {
      ...
      val answers = emptyUserAnswersForUtr
        ...
        .set(DeceasedSettlorCountryOfResidenceInTheUkYesNoPage, true)
        .value
        .set(SettlorLastKnownAddressYesNoPage, false)
        .value
        .set(SettlorIndividualOrBusinessPage(0), IndividualOrBusiness.Business)
        .value
        .set(SettlorBusinessNamePage(0), "Amazon")
        .value
        .set(SettlorUtrYesNoPage(0), false)
        .value
        .set(SettlorCountryOfResidenceYesNoPage(0), false)
        .value
        .set(SettlorAddressYesNoPage(0), false)
        .value
        .set(SettlorIndividualOrBusinessPage(1), IndividualOrBusiness.Individual)
        .value
        .set(SettlorIndividualNamePage(1), FullName("Joe", None, "Bloggs"))
        .value
        .set(SettlorIndividualDateOfBirthYesNoPage(1), false)
        .value
        .set(SettlorCountryOfNationalityYesNoPage(1), false)
        .value
        .set(SettlorIndividualNINOYesNoPage(1), false)
        .value
        .set(SettlorCountryOfResidenceYesNoPage(1), false)
        .value
        .set(SettlorAddressYesNoPage(1), false)
        .value
        .set(SettlorIndividualMentalCapacityYesNoPage(1), true)
        .value
